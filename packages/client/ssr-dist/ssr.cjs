...
function requireReactDomServerLegacy_node_production_min() {
  ...
  var ea = requireReact(), fa = require$$1__default.default, n = Object.prototype.hasOwnProperty, ha = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, ia = {}, ja = {};
  function ka(a) {
    if (n.call(ja, a))
      return true;
    if (n.call(ia, a))
...
function requireReactDomServer_node_production_min() {
  ...
  var aa = require$$0__default.default, ba = requireReact(), k = null, l2 = 0, q = true;
  function r(a, b) {
    if ("string" === typeof b) {
      if (0 !== b.length)
        if (2048 < 3 * b.length)
