...
export const routeConfig: Record<APP_ROUTES, RouteProps> = {
  [APP_ROUTES.MAIN]: {
      path: RoutePath.main,
      element: <AuthGuard><GamePreview /></AuthGuard>,
  },
  ...
  [APP_ROUTES.GAME]: {
      path: RoutePath.game,
      element: <AuthGuard><div>Game Page</div></AuthGuard>,
  },
  [APP_ROUTES.LEADERBOARD]: {
      path: RoutePath.leaderboard,
      element: <AuthGuard><div>LeaderBoard Page</div></AuthGuard>,
  },
  [APP_ROUTES.FORUM]: {
      path: RoutePath.forum,
      element: <AuthGuard><div>Forum Page</div></AuthGuard>,
  },
